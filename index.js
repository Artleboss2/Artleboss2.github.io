...
const translations = {
  fr: {
    ...
    hero: {
      ...
      description: "Je développe des applications, texture packs et outils créatifs pour la communauté gaming. Spécialisé dans la customisation de jeux, les applications mobiles et l'automatisation système.",
    ...
    projects: {
      ...
      project1: {
        ...
        description: "Application mobile de gestion de tâches avec interface moderne et intuitive. Système de catégorisation, rappels et synchronisation multi-plateforme. Développée avec des standards juridiques complets (CLUF) et conformité aux lois canadiennes sur la protection des données.",
      },
      project2: {
        title: "Bloxd Texture Pack",
        description: "Texture pack personnalisé pour Bloxd.io permettant de modifier l'apparence des blocs, skybox, items et modèles 3D. Système de customisation CSS avancé pour personnaliser l'interface du jeu.",
      },
      project3: {
        title: "Batch Multitool",
        description: "Outil multifonction développé en Batch pour automatiser des tâches basiques système. Interface en ligne de commande intuitive pour faciliter l'administration Windows.",
      },
      project4: {
        title: "Portfolio GitHub",
        description: "Portfolio professionnel interactif avec animations réactives au curseur, particules génératives et design moderne. Terminal interactif intégré et jeu Snake. Optimisé pour les performances et l'expérience utilisateur.",
      },
      project5: {
        title: "St-Mars E L Inc — Refonte Web",
        description: "Refonte numérique premium pour une entreprise familiale de plomberie et chauffage à Montréal, fondée en 1937. Design «Luxe Industriel» avec animations de scroll inversé, effets parallaxe et identité visuelle modernisée sur 4 générations.",
      },
      project6: {
        title: "NFT Generator",
        description: "Générateur d'NFT interactif permettant de créer et visualiser des actifs numériques uniques directement dans le navigateur. Interface web moderne avec génération algorithmique de combinaisons d'attributs et prévisualisation en temps réel.",
      },
      project7: {
        title: "Phone Simulation",
        description: "Simulation interactive d'interface smartphone dans le navigateur. Reproduction fidèle des interactions tactiles, notifications, applications et gestes courants d'un téléphone moderne. Expérience immersive entièrement construite en technologies web.",
      },
      project8: {
        title: "UI Components Library",
        description: "Collection de composants et maquettes d'interfaces utilisateur modernes. Ensemble de designs réutilisables incluant boutons, cartes, modales et layouts avancés. Vitrine de compétences en design system et cohérence visuelle.",
      },
      project9: {
        title: "Music Page",
        description: "Page musicale interactive avec lecteur audio personnalisé, gestion de licences et notices légales intégrées. Interface immersive dédiée à la découverte et l'écoute de créations musicales, avec documentation complète des droits d'auteur.",
      },
    },
    repos: {
  ...
  en: {
    ...
    hero: {
      ...
      description: "I develop applications, texture packs and creative tools for the gaming community. Specialized in game customization, mobile applications and system automation.",
    ...
    projects: {
      ...
      project1: {
        title: "Zynit — To-Do List App",
        description: "Mobile task management application with modern and intuitive interface. Categorization system, reminders and multi-platform synchronization. Developed with complete legal standards (EULA) and compliance with Canadian data protection laws.",
      },
      project2: {
        title: "Bloxd Texture Pack",
        description: "Custom texture pack for Bloxd.io allowing to modify the appearance of blocks, skybox, items and 3D models. Advanced CSS customization system to personalize the game interface.",
      },
      project3: {
        title: "Batch Multitool",
        description: "Multifunction tool developed in Batch to automate basic system tasks. Intuitive command-line interface to facilitate Windows administration.",
      },
      project4: {
        title: "GitHub Portfolio",
        description: "Interactive professional portfolio with cursor-reactive animations, generative particles and modern design. Integrated interactive terminal and Snake game. Optimized for performance and user experience.",
      },
      project5: {
        title: "St-Mars E L Inc — Web Redesign",
        description: "Premium digital redesign for a family-owned plumbing and heating company in Montreal, founded in 1937. \"Luxury Industrial\" design with reverse scroll animations, parallax effects and modernized visual identity spanning 4 generations.",
      },
      project6: {
        title: "NFT Generator",
        description: "Interactive NFT generator allowing you to create and visualize unique digital assets directly in the browser. Modern web interface with algorithmic generation of attribute combinations and real-time preview.",
      },
      project7: {
        title: "Phone Simulation",
        description: "Interactive smartphone interface simulation in the browser. Faithful reproduction of touch interactions, notifications, apps and common gestures of a modern phone. Fully immersive experience built with web technologies.",
      },
      project8: {
        title: "UI Components Library",
        description: "Collection of modern user interface components and mockups. Set of reusable designs including buttons, cards, modals and advanced layouts. Showcase of design system skills and visual consistency.",
      },
      project9: {
        title: "Music Page",
        description: "Interactive music page with custom audio player, license management and integrated legal notices. Immersive interface dedicated to discovering and listening to musical creations, with complete copyright documentation.",
      },
    },
    repos: {
...
const commands = {
  ...
  about: {
    execute: () => `<div class="terminal-success">À propos de moi:</div><div class="terminal-info">Développeur passionné par le gaming et la création.<br>Applications mobiles, texture packs, outils d'automatisation,<br>redesigns web et projets créatifs.<br><br>Spécialités: Mobile Dev, Web Dev, Game Modding, Automation</div>`,
  },
  skills: {
    execute: () => `<div class="terminal-success">Compétences principales:</div><div class="terminal-info">Frontend: HTML5, CSS3, JavaScript, React Native<br>Mobile: Cross-platform Apps, UI/UX Design<br>Game Dev: Texture Packs, WebGL, 3D Modeling<br>Automation: Batch, Shell Scripting<br>Tools: Git, VS Code, GitHub Pages</div>`,
  },
  projects: {
    execute: () => `<div class="terminal-success">Projets sélectionnés (9):</div><div class="terminal-info">01. Zynit - Application mobile de to-do list<br>02. Bloxd Texture Pack - Customisation CSS pour Bloxd.io<br>03. Batch Multitool - Automatisation Windows<br>04. Portfolio GitHub - Ce site!<br>05. St-Mars E L Inc - Refonte web plomberie Montréal<br>06. NFT Generator - Générateur d'actifs numériques<br>07. Phone Simulation - Simulation d'interface mobile<br>08. UI Components - Bibliothèque de composants UI<br>09. Music Page - Lecteur musical interactif</div>`,
  },
  repos: {
    execute: () => `<div class="terminal-success">Tous les repositories (19 publics):</div><div class="terminal-info">🌐 WEB: Artleboss2.github.io · Plomberie · Zynit · Game-Tracker · Bloxd-Texture-Pack<br>⬡ OUTILS: Batch-Multitool · Powershell-Starting-Animation · Schematic-Converter · TradingView-Script · Perfect-Repository-Bot<br>◇ RESSOURCES: awesome-ai · awesome-prompt-engineering · Everything-Explained · CLAUDE-SKILLS · .Md-challenge · Artleboss2 (profile)<br>⟡ CONTRIBUTIONS: public-apis · XTranslation<br><br>Visitez github.com/Artleboss2 pour tous les repos.</div>`,
  },
  contact: {
    execute: () => `<div class="terminal-success">Contact:</div><div class="terminal-info">GitHub: github.com/Artleboss2<br>Email: contact@artleboss.com<br>Discord: Disponible sur demande<br>LinkedIn: À venir</div>`,
  },
  github: {
    execute: () => {
  ...
  social: {
    execute: () => `<div class="terminal-success">Réseaux sociaux:</div><div class="terminal-info">🐙 GitHub: github.com/Artleboss2<br>💼 LinkedIn: À venir<br>💬 Discord: Disponible sur demande<br>📧 Email: contact@artleboss.com</div>`,
  },
  matrix: {
